...
Devise.setup do |config|
  ...
  config.mailer_sender = 'boomshakala@vettio.com'
  ...
  config.pepper = '19fb6f553dde79f2e49d0d545e7140b22bcdd90aa57e3b2769f6f75989a59391c67c5789eb3dd3dc13d78a4cd922c94a1927523e5245dfc1be65a046b6c5a344'
  ...
  Settings.authentication.providers.each do | provider_name, provider_data |
    ...
    Rails.logger.info "Parsing configuration for #{provider_name} into Devise..."
    provider_args = {}
    ...
    Rails.logger.info provider_args.to_yaml
